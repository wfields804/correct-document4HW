...
class Cart():
    ...
    #I get an error when I run this code, it says "can only concatenate str (not "int") to str", but I do not see why. Please explain teacher.
...
#It also shows list, but every changed needs to be changed manually. I wanted it to be automatic from inputs, but I dont believe thats the assignment. 
